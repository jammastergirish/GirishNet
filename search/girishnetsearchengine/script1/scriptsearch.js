...
//I have edited it quite a bit, you can send an e-mail
//to me at girishnet@globalnet.co.uk.
//              
//                Girish Gupta
...
document.write('<form name="entryform" onSubmit="return entry()">'
 +'<b>Search for:</b><br><input type="text" size=30 '
...
if ((menu_length == 0) && (location.search.length > 1))
 document.write('Nothing could be found that has anything to do with '+string+'! Try searching <a href="http://www.yahoo.com" target="new window">YAHOO!</a> for '+string+'\n');
// -->