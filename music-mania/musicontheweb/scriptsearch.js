...
if (location.search.length > 1)
 document.write('</center>Your search for <b>'+string+'</b> came up with: <br><br>\n');

for (n=0; n<menu_length; n++)
 document.write('<b><a href="'+menu[n].url+'">'+menu[n].title
 +'</a></b><br>'
 +'<a href="'+menu[n].url+'">'+menu[n].url+'</a><br><br>\n');
if ((menu_length == 0) && (location.search.length > 1))
 document.write('Nothing could be found that has anything to do with <b>'+string+'</b>!\n');
// -->